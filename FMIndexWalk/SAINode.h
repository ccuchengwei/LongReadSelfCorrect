...
class SAINode
{
	public:
		...
		virtual SAINode* createChild(const std::string& label);
...
class SAIPBNode : public SAINode
{
	public:
		SAIPBNode(const std::string* pQuery, SAINode* parent):SAINode(pQuery, parent){ };
		~SAIPBNode(void) = default;
